...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    // So sánh 2 vật: ốc sên / bể cá
    "more_chili": { src: `${BASE_PATH}x-chili.mp3`, volume: 1.0 },
    "more_veg": { src: `${BASE_PATH}x-veg.mp3`, volume: 1.0 },
    "more_flower": { src: `${BASE_PATH}x-flower.mp3`, volume: 1.0 },
    // Lời nhắc bỏ bớt vật
    "remove_chili": { src: `${BASE_PATH}add_chili.mp3`, volume: 1.0 },
    "remove_veg": { src: `${BASE_PATH}add_veg.mp3`, volume: 1.0 },
};
