...
const SOUND_MAP: Record<string, SoundConfig> = {
    ...
    "less_snail": { src: `${BASE_PATH}x-snail.mp3`, volume: 1.0 },
    "less_aquarium": { src: `${BASE_PATH}x-fish.mp3`, volume: 1.0 },
    // Hướng dẫn thêm vật / bể (màn phụ BalanceScene)
    "add_snail": { src: `${BASE_PATH}add-snail.mp3`, volume: 1.0 },
    "add_aquarium": { src: `${BASE_PATH}add-fish.mp3`, volume: 1.0 },
};
